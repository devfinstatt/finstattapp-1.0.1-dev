...
$(function () {
    ...
    if(typeof app !== 'undefined'){
        ...
        if(
            app.enable_age_verification_dialog && !(app.tosPageSlug !== null && window.location.href.indexOf(app.tosPageSlug) >= 1) && !(app.privacyPageSlug !== null && window.location.href.indexOf(app.privacyPageSlug) >= 1) && !(window.location.href.indexOf('invoices') >= 1)
        ){
